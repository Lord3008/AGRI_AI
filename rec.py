...
def recommend_crop_gemini(soil_type, pH, nitrogen, phosphorus, potassium, rainfall, temperature, location):
    ...
    End with "Thank you for using the Smart Crop Recommendation System at KrushiSaathi 🌾🌾🌾." This should be out of the table.
    """
...
# Streamlit UI
st.markdown("""
    <h1 style='color: #2e7d32;'>🌾 Smart Crop Recommendation System at KrushiSaathi</h1>
